...
export default class CameraScreen extends React.Component {
  ...
  renderTopBar = () => 
  <ImageBackground source={require('../screens/shapes/camera-panel.png')} style={{flex: 1, height: 44, flexDirection: 'row', justifyContent: 'center', alignItems: 'center',  }}>
    <TouchableOpacity style={styles.toggleButton} onPress={this.toggleFacing}>
        <Image source={require('../screens/icons/reverse-camera.png')}/>
      </TouchableOpacity>
      <TouchableOpacity style={styles.toggleButton} onPress={this.toggleFacing}>
        <Image source={require('../screens/icons/album.png')}/>
      </TouchableOpacity>
      <TouchableOpacity style={styles.toggleButton} onPress={this.toggleFacing}>
        <Image source={require('../screens/icons/grid.png')}/> 
      </TouchableOpacity> 
  </ImageBackground> 
    ...
    /* <View
      style={styles.topBar}>
      <TouchableOpacity style={styles.toggleButton} onPress={this.toggleFacing}>
        <Ionicons name="ios-reverse-camera" size={20} color="white" />
      </TouchableOpacity>
      <TouchableOpacity style={styles.toggleButton} onPress={this.toggleFlash}>
        <MaterialIcons name={flashIcons[this.state.flash]} size={20} color="white" />
      </TouchableOpacity>
      ...
      <View style={{flex: 1}}>
        ...
        <View style={styles.containerWhole}>
          <View style={styles.imageArea}> {/* this is where the first half of the challenge goes */}
            <Image source={require('../images/food.png')}  style={{width: 170, height: 337}} /> 
          ...
          {/* to switch right and left, cut and paste the code from lines 321-324 below this line */}

        </View>

        <View style={{flex: 0.14, paddingTop: 10, paddingBottom: 20}}>
          {this.renderTopBar()}
